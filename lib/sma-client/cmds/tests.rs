...
fn deserialize_login()
{
    ...
    [
        0x53, 0x4d, 0x41, 0x00, 0x00, 0x04, 0x02, 0xa0,
        0x00, 0x00, 0x00, 0x01, 0x00, 0x3a, 0x00, 0x10,
        0x60, 0x65, 0x0e, 0xd0, 0x7d, 0x00, 0xeb, 0x7b,
        0xb8, 0x33, 0x00, 0x01, 0x8a, 0x00, 0xd5, 0x66,
        0xfb, 0x7e, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
        0x03, 0x80, 0x0d, 0x04, 0xfd, 0xff, 0x07, 0x00,
        0x00, 0x00, 0x84, 0x03, 0x00, 0x00, 0x32, 0x8f,
        0xcd, 0x5c, 0x00, 0x00, 0x00, 0x00, 0xb8, 0xb8,
        0xb8, 0xb8, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88,
        0x88, 0x88, 0x00, 0x00, 0x00, 0x00
    ]);
    let response = parse_command(&mut input_buffer, &None);
...
fn deserialize_login2()
{
    ...
    [
        ...
        0x60, 0x65, 0x0B, 0xE0, 0xDE, 0xAD, 0xDE, 0xAD,
        0xBE, 0xEA, 0x00, 0x01, 0x98, 0x01, 0x36, 0xE3,
        0x39, 0xB3, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
        0x02, 0x80, 0x0D, 0x04, 0xFD, 0xFF, 0x07, 0x00,
        0x00, 0x00, 0x84, 0x03, 0x00, 0x00, 0xD9, 0xAA,
...
fn deserialize_failed_login()
{
    ...
    [
        ...
        0x60, 0x65, 0x0e, 0xd0, 0x7d, 0x00, 0xeb, 0x7b,
        0xb8, 0x33, 0x00, 0x01, 0x8a, 0x00, 0xd5, 0x66,
        0xfb, 0x7e, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00,
        0x03, 0x80, 0x0d, 0x04, 0xfd, 0xff, 0x07, 0x00,
        0x00, 0x00, 0x84, 0x03, 0x00, 0x00, 0x32, 0x8f,
        0xcd, 0x5c, 0x00, 0x00, 0x00, 0x00, 0xb8, 0xb8,
        0xb8, 0xb8, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88,
...
fn deserialize_get_day_data()
{
    ...
    [
        ...
        0x60, 0x65, 0x15, 0xd0, 0xde, 0xad, 0xde, 0xad,
        0xbe, 0xea, 0x00, 0xa0, 0x8a, 0x00, 0xd5, 0x66,
        0xfb, 0x7e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x08, 0x80, 0x01, 0x02, 0x00, 0x70, 0x45, 0x27,
        0x00, 0x00, 0x48, 0x27, 0x00, 0x00, 0xdc, 0x60,
        0xed, 0x5c, 0xf6, 0x97, 0xc2, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x08, 0x62, 0xed, 0x5c, 0xff, 0x97,
        0xc2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x34, 0x63,
        0xed, 0x5c, 0x08, 0x98, 0xc2, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x60, 0x64, 0xed, 0x5c, 0x10, 0x98,
    ...
    [
        TimestampedInt { timestamp: 1559060700, value: 12752886 },
        TimestampedInt { timestamp: 1559061000, value: 12752895 },
        TimestampedInt { timestamp: 1559061300, value: 12752904 },
        TimestampedInt { timestamp: 1559061600, value: 12752912 }
    ];
...
fn reject_random_junk()
{
    let mut input_buffer = Cursor::new(vec!
    [
        0xCB, 0xF2, 0x87, 0x99, 0xA7, 0x35, 0x70, 0x5E,
        0xAE, 0x51, 0x2B, 0xEE, 0xC9, 0x66, 0x08, 0xF2,
        0x7F, 0x84, 0x54, 0x72, 0xC5, 0x23, 0x77, 0x2B,
        0xF1, 0x01, 0x3F, 0x27, 0xDC, 0x2F, 0x26, 0x05,
        0xE8, 0xCC, 0xC4, 0xAC, 0x38, 0x24, 0x47, 0xBD,
        0x27, 0x28, 0xEB, 0x8A, 0x4A, 0x93, 0x97, 0x22,
