...
class WaterSwitch extends Component
{
    ...
    {
        return (
            <g key={"vpipe" + pos} transform={"translate(" +
                ...
                <ellipse cx="26.458" cy="47.096" rx="3.175" ry="2.54"
                    fill="#4c9ac8" stroke="url(#linearGradientPipeVHoleStroke)"
                    strokeLinecap="round" strokeLinejoin="round"
                    strokeWidth=".212" />
                <g transform="translate(0 2.6458)">
                    ...
                    <ellipse transform="matrix(.94591 0 0 .94591 1.4312 2.9769)"
                        ...
                        stroke="#cfd5ff" strokeLinecap="round"
        ...
        return(
            <g transform={"matrix(1.556 0 0 1.556 " +
                ...
                <path d="m27.093 33.867c0 0.2338-0.2843 0.42333-0.635
                    ...
                    fill="none" stroke="url(#linearGradientValveTipSpecularOpen)"
                    strokeLinecap="round" strokeLinejoin="round" strokeWidth=".1" />
            </g>
        );
    }
        ...
        return(
            <g transform={"matrix(1.556 0 0 1.556 " +
                ...
                <path d="m27.093 35.772c0 0.2338-0.2843 0.42333-0.635
                        0.42333s-0.635-0.18953-0.635-0.42333"
                    fill="none" stroke="url(#linearGradientValveTipSpecularClosed)"
                    strokeLinecap="round" strokeLinejoin="round" strokeWidth=".1" />
            </g>
        );
    }
